...
module.exports  = class MeuTokenJWT  { 
    constructor() {
        ...
        this._sub = "sistema_gerenciamento_funcionarios"; // Assunto do token
    ...
    gerarToken(parametroClaims) {
        ...
        const payload = {
            ...
            nome: parametroClaims.nomefuncionario, // Claims públicas
            email: parametroClaims.emailfuncionario,
        };
